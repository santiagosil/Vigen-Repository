...
namespace Vigen_Repository.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          ...
          {
              return Problem("Entity set 'vigenContext.Users'  is null.");
          }
            ...
            {
                if (UserExists(user.Identification))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetUser", new { id = user.Identification }, user);
        }
        ...
        {
            return (_context.Users?.Any(e => e.Identification == id)).GetValueOrDefault();
        }
    }
}